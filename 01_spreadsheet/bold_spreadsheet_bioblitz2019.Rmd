...
#1894 1936
filter(new, Project == want, new$`Red/Coralline/Green/Brown` == "Coralline")

submit <- new %>% 
  filter(Project == want, `Red/Coralline/Green/Brown` == phyla, `Red/Coralline/Green/Brown` == "Coralline")
```
